                ...
                <div class="col-6">
                    ...
                    <div class="login-form">
                        ...
                        <div class= "text-center mt-4">
                            <span class="d-inline">Belum punya akun?<a href="#" class="register d-inline text-decoration-underline">Daftar di sini</a></span>
                        </div>
                        <div class="text-center mt-2">
                            <a href="#" class="text-decoration-underline font-weight-bold">Lupa password?</a>
                        </div>    
                    </div> 
                </div>    
            </div>      
